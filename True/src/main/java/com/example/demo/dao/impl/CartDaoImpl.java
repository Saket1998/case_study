...
//	}
	...
	public int addCartItem(long userId, long menuItemId) {
		...
		String sql1 = "SELECT * FROM MenuItem WHERE itemid in (select itemid from user where userid= ?)";
	...
	public List<MenuItem> getAllCartItems(long userId) {
		AdminRowMapper adminRowMapper = new AdminRowMapper();
		String sql = "SELECT * FROM MenuItem WHERE itemid in (select itemid from user where userid= ?)";
